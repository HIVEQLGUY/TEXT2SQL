CREATE TABLE IF NOT EXISTS youmei_sandbox.dwd_trade_order_df
(
...
INSERT INTO youmei_sandbox.dwd_trade_order_df
WITH normalized AS
(
    SELECT DISTINCT
...
WHERE shop_id IS NOT NULL
  ...
  AND (SELECT count() FROM youmei_sandbox.dwd_trade_order_df WHERE snapshot_date = toDate('2026-07-22')) = 0;

INSERT INTO youmei_sandbox.dwd_trade_order_item_df
...
WHERE shop_id IS NOT NULL
  AND shop_order_id IS NOT NULL
  AND (SELECT count() FROM youmei_sandbox.dwd_trade_order_item_df WHERE snapshot_date = toDate('2026-07-22')) = 0;
